...
pub struct Theme {
    ...
    pub search_active_match_background: Color32,
...
fn warm_paper_theme() -> Theme {
    Theme {
        ...
        search_match_background: Color32::from_rgb(255, 244, 181),
        search_active_match_background: Color32::from_rgb(255, 180, 82),
...
fn mist_theme() -> Theme {
    Theme {
        ...
        search_match_background: Color32::from_rgb(255, 244, 174),
        search_active_match_background: Color32::from_rgb(255, 172, 88),
...
fn night_owl_theme() -> Theme {
    Theme {
        ...
        search_match_background: Color32::from_rgb(91, 73, 25),
        search_active_match_background: Color32::from_rgb(173, 98, 30),
